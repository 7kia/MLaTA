...
{
	BOOST_CHECK_THROW(TestApplictation("input0.txt", "output1.txt"), std::ifstream::failure);
}
...
BOOST_AUTO_TEST_CASE(a_lot_repeats)
{
...
BOOST_AUTO_TEST_CASE(several_strings_in_file)
{
...
BOOST_AUTO_TEST_CASE(string_not_found)
{
